...
typedef enum
{
    ...
    THERMAL_AI_CLASS_PERSON = 1U,
    THERMAL_AI_CLASS_HAND = 2U,
    THERMAL_AI_CLASS_HOT_OBJECT = 3U,
    THERMAL_AI_CLASS_CIRCUIT_BOARD_NORMAL = 4U,
    THERMAL_AI_CLASS_CIRCUIT_BOARD_ABNORMAL_HOTSPOT = 5U
} thermal_ai_class_t;

typedef enum
{
    THERMAL_AI_MODE_PEOPLE_MONITOR = 0U,
    THERMAL_AI_MODE_HOT_OBJECT_MONITOR = 1U,
    THERMAL_AI_MODE_BOARD_INSPECTION = 2U
