...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
/* Tiny1-C 热成像业务已下沉到应用层 tiny1c_thermal_app.c，main 仅负责启动与轮询调度。 */
/* USER CODE END 0 */
...
/* USER CODE END RIF_Init 0 */
  ...
  if (HAL_DMA_ConfigChannelAttributes(&handle_HPDMA1_Channel15,DMA_CHANNEL_SEC|DMA_CHANNEL_PRIV|DMA_CHANNEL_SRC_NSEC|DMA_CHANNEL_DEST_NSEC)!= HAL_OK )
  {
    Error_Handler();
  }
