...
BSP/EEPROM/%.o BSP/EEPROM/%.su BSP/EEPROM/%.cyclo: ../BSP/EEPROM/%.c BSP/EEPROM/subdir.mk
...
clean: clean-BSP-2f-EEPROM

clean-BSP-2f-EEPROM:
	-$(RM) ./BSP/EEPROM/eeprom.cyclo ./BSP/EEPROM/eeprom.d ./BSP/EEPROM/eeprom.o ./BSP/EEPROM/eeprom.su

.PHONY: clean-BSP-2f-EEPROM
