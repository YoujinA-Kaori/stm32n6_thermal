...
#define THERMAL_GUI_PREVIEW_IMG_X            (56)
#define THERMAL_GUI_PREVIEW_IMG_Y            (42)
...
void setup_scr_WidgetsDemo(lv_ui *ui)
{
    ...
    ui->WidgetsDemo_status_pseudo = thermal_gui_create_status_badge(ui->WidgetsDemo_status_bar, "伪彩 铁红", lv_color_hex(0xff8c3a), 220, 92);
    ui->WidgetsDemo_status_gain = thermal_gui_create_status_badge(ui->WidgetsDemo_status_bar, "增益 高", lv_color_hex(0xffbf47), 318, 82);
    ...
    thermal_gui_create_palette_button(page, "热像", 8, 94, lv_color_hex(0x3b0a09), lv_color_hex(0xff7a1a), true);
    thermal_gui_create_palette_button(page, "绿热", 140, 94, lv_color_hex(0x0d3f18), lv_color_hex(0xb8ff4d), false);
    thermal_gui_create_palette_button(page, "锐化", 8, 142, lv_color_hex(0x0f6f94), lv_color_hex(0xf4d15c), false);
    ...
    thermal_gui_create_palette_button(page, "保留", 8, 286, lv_color_hex(0x3a3f44), lv_color_hex(0x5c6670), false);

    note_box = lv_obj_create(page);
    lv_obj_set_pos(note_box, 8, 336);
    ...
    label = lv_label_create(page);
    lv_label_set_text(label, "休眠时间");
    lv_obj_set_pos(label, 8, 6);
    lv_obj_set_style_text_color(label, lv_color_hex(0xe6ebef), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(label, THERMAL_GUI_CN_FONT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ui->WidgetsDemo_ddlist_sleep = lv_dropdown_create(page);
    lv_dropdown_set_options(ui->WidgetsDemo_ddlist_sleep, "30 s\n1 min\n3 min\n5 min\nNever");
    lv_obj_set_pos(ui->WidgetsDemo_ddlist_sleep, 140, 0);
    lv_obj_set_size(ui->WidgetsDemo_ddlist_sleep, 118, 36);
    lv_obj_set_style_bg_color(ui->WidgetsDemo_ddlist_sleep, lv_color_hex(0x242b33), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->WidgetsDemo_ddlist_sleep, lv_color_hex(0x4d5964), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->WidgetsDemo_ddlist_sleep, lv_color_hex(0xf0f4f7), LV_PART_MAIN | LV_STATE_DEFAULT);

    ui->WidgetsDemo_sw_alarm = thermal_gui_create_switch_row(page, "报警开关", 54, true);

    ui->WidgetsDemo_btn_save_cfg = thermal_gui_create_action_button(page, "保存配置", 0, 112, lv_color_hex(0xffb454), true);
    ui->WidgetsDemo_btn_restore_cfg = thermal_gui_create_action_button(page, "恢复默认", 118, 112, lv_color_hex(0x7bc6ff), false);
    lv_obj_set_pos(ui->WidgetsDemo_btn_save_cfg, 8, 96);
    lv_obj_set_pos(ui->WidgetsDemo_btn_restore_cfg, 140, 96);

    ui->WidgetsDemo_btn_device_info = lv_obj_create(page);
    lv_obj_set_pos(ui->WidgetsDemo_btn_device_info, 8, 146);
    lv_obj_set_size(ui->WidgetsDemo_btn_device_info, 250, 94);
    ...
    lv_obj_set_size(ui->WidgetsDemo_preview_img, 320, 240);
    ...
    lv_obj_set_pos(ui->WidgetsDemo_preview_cross_h,
                   THERMAL_GUI_PREVIEW_IMG_X + ((320 - THERMAL_GUI_PREVIEW_CROSS_LEN) / 2),
                   THERMAL_GUI_PREVIEW_IMG_Y + 120);
    ...
    lv_obj_set_pos(ui->WidgetsDemo_preview_cross_v,
                   THERMAL_GUI_PREVIEW_IMG_X + 160,
                   THERMAL_GUI_PREVIEW_IMG_Y + ((240 - THERMAL_GUI_PREVIEW_CROSS_LEN) / 2));
    ...
    ui->WidgetsDemo_btn_restore = thermal_gui_create_footer_button(ui->WidgetsDemo_footer_bar, "恢复默认", 134, 124, lv_color_hex(0x7bc6ff), false);
    ui->WidgetsDemo_btn_ffc = thermal_gui_create_footer_button(ui->WidgetsDemo_footer_bar, "手动 FFC", 272, 124, lv_color_hex(0x48b3ff), true);
...
void setup_scr_WidgetsDemoFullscreen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->WidgetsDemo_fullscreen_preview_min_temp, 12, 440);
    ui->WidgetsDemo_fullscreen_preview_palette_name = thermal_gui_create_status_badge(ui->WidgetsDemo_fullscreen_preview_frame, "锐化", lv_color_hex(0xffb454), 500, 108);
    lv_obj_set_pos(ui->WidgetsDemo_fullscreen_preview_palette_name, 500, 440);

    ui->WidgetsDemo_fullscreen_preview_max_marker = thermal_gui_create_marker_label(ui->WidgetsDemo_fullscreen_preview_frame, "高", 520, 120);

    ui->WidgetsDemo_fullscreen_preview_min_marker = thermal_gui_create_marker_label(ui->WidgetsDemo_fullscreen_preview_frame, "低", 100, 360);
